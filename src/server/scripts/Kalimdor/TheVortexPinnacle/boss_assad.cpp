					...
					while (uint32 eventId = events.ExecuteEvent())
					{
						switch(eventId)
						{
							...
							case EVENT_SUMMON:
								...
								me->SummonCreature(NPC_SKYFALL_STAR, aSpawnLocations[4].GetPositionX(), aSpawnLocations[4].GetPositionY(), aSpawnLocations[4].GetPositionZ(), 0.0f, TEMPSUMMON_CORPSE_DESPAWN);
								events.ScheduleEvent(EVENT_SUMMON, 20000);
								return;
						}
					}
